 ...
 * @author Daniel Dyer
 */
public class CustomListOrderCrossover<T> extends AbstractCrossover<List<T>>
{
    /**
     * Creates a cross-over operator with a cross-over probability of 1.
     */
    public CustomListOrderCrossover()
    {
     ...
     * for any given pair.
     */
    public CustomListOrderCrossover(Probability crossoverProbability)
    {
     ...
     */
    public CustomListOrderCrossover(NumberGenerator<Probability> crossoverProbabilityVariable)
    {
                                 ...
                                 Random rng)
    {
        ...
        if(Config.SHOW_Crossover) {
        	this.showCrossover(parent1, parent2, offspring1, offspring2);
        }
        return result;
    }
    ...
    private void showCrossover(List<T> parent1, List<T> parent2, List<T> offspring1, List<T> offspring2) {
    	System.out.println("The first parent is " + parent1);
    	System.out.println("The second parent is " + parent2);
    	System.out.println("The first offspring is " + offspring1);
    	System.out.println("The second offspring is " + offspring2);
        System.out.println("----------------------------");
    }
}