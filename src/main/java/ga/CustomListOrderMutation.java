 ...
 * @author Daniel Dyer
 */
public class CustomListOrderMutation<T> implements EvolutionaryOperator<List<T>>
{
     ...
     */
    public CustomListOrderMutation()
    {
        this(1, 1);
    }
     ...
     */
    public CustomListOrderMutation(int mutationCount, int mutationAmount)
    {
     ...
     */
    public CustomListOrderMutation(NumberGenerator<Integer> mutationCount,
    ...
    public List<List<T>> apply(List<List<T>> selectedCandidates, Random rng)
    {
        ...
        for (List<T> candidate : selectedCandidates)
        {
            ...
            if(Config.SHOW_MUTATION) {
            	this.showMutation(candidate, newCandidate);
            }
        }
    ...
    private void showMutation(List<T> candidate, List<T> newCandidate) {
    	System.out.println("-------------------");
    	System.out.println(candidate);
        System.out.println("--- Has been mutated to ---");
